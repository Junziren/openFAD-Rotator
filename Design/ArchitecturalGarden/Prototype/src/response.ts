import { defaultSpeakerProfiles } from "../../../../WebUI/src/parameterContract";

// The same schematic voicing curve as the existing GUI, not a measured DSP EQ.
export function drawResponse(canvas: HTMLCanvasElement, model: number) {
  const profile = defaultSpeakerProfiles[model];
